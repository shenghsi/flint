---
title: Extensions
description: "Extend Flint with themes, language support, AI tools, and more through the extension system."
---

# Extensions

Flint lets you add new functionality using user-defined extensions.
