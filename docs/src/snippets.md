---
title: Snippets - Flint
description: Create and use code snippets in Flint with tab stops, placeholders, variables, and language-scoped triggers.
---
...
The snippets are located in `~/.config/flint/snippets` directory to which you can navigate with the {#action snippets::OpenFolder} action.
