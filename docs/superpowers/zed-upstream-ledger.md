...
| P2 | [#61275 line shaping](https://github.com/zed-industries/zed/pull/61275) | `ac5538b7239196b7413da76a6258bc9ac4a017fe` | v1.13.0-pre notes | Absent | `crates/editor` | `none` | None | `editor_render_with_color_inlays` | `deferred` | — | Two A/B runs found no measurable render improvement: +0.32% at p=0.76 and +0.28% at p=0.78, with both confidence intervals spanning zero. The production edit is not ported. |
