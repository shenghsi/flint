...
| P2 | [#59912](https://github.com/zed-industries/zed/pull/59912) | `8186af99a347dfa9f9fd5af88da419b97b9727fa` | resolved discovery | Absent | `crates/workspace`, `crates/picker`, picker consumers | `reimplement` | Tasks 6.1-6.4 | Task 6.5 reconstructible picker requests | `implementing` | — | Do not retain upstream's live dismissed modal; reconstruct current state instead. |
| P2 | [#61002](https://github.com/zed-industries/zed/pull/61002) | `4ebc1545d299b1270bc76813fa841357ee711b19` | later fix to #59912 | Absent | `crates/workspace` | `adapt` | #59912 | Task 6.5 Command Palette and Which Key dismissal ordering | `implementing` | — | Queue reconstruction until the transient modal has closed. |
