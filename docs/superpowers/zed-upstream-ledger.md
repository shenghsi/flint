...
| P1 | [#52537](https://github.com/zed-industries/zed/pull/52537) | `776585038e56672e2bb5ee48899c79c654aeaba2` | v1.10 notes | Absent | `crates/workspace`, `crates/terminal_view` | `adapt` | None | Task 3.6c remote absolute paths outside worktrees with Unicode row/column preservation | `implementing` | [#91](https://github.com/shenghsi/flint/pull/91) | Remote terminal links use the shared project path-resolution RPC; Agent Threads routing is unchanged. |
