...
| P2 | [#61275 operation sorting](https://github.com/zed-industries/zed/pull/61275) | `ac5538b7239196b7413da76a6258bc9ac4a017fe` | v1.13.0-pre notes | Absent | `crates/text` | `adapt` | None | `insert_10k_unique_shuffled_operations` | `implementing` | — | Unstable sorting improved real queue insertion by 10.71% and 10.60% in two statistically significant A/B runs. |
