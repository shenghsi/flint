...
| P1 | [#59272](https://github.com/zed-industries/zed/pull/59272) | `338530f2e9b36ea05cc27db96e8f2270bd32cd12` | v1.8 notes | Absent | `crates/recent_projects`, `crates/workspace` | `adapt` | #58157 | Task 3.2 remote picker, close, and remove transitions | `implementing` | [#80](https://github.com/shenghsi/flint/pull/80) | Flint already reopened restored remote groups through its shared remote-project path. Adapt the two remaining local fallback sites so an unloaded remote neighbor cannot create a ghost workspace. |
| P1 | [#53953](https://github.com/zed-industries/zed/pull/53953) | `2838ea3f59458fc550d844e78fb4fec8eaf39fa3` | v1.12 notes | Absent | `crates/recent_projects` | `adapt` | #58157 | Task 3.2 local/remote same-path and different-host filtering | `implementing` | [#80](https://github.com/shenghsi/flint/pull/80) | Compare the persisted workspace location with the open folder's semantic remote connection identity. Direct and Tunneled remain transport modes for the same checkout, and the persistence key does not change. |
