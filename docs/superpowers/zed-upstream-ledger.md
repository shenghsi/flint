...
| P0 | [#58867](https://github.com/zed-industries/zed/pull/58867) | `7f6f93c089e5ed50342e2c4288a71545ddaf4f5d` | v1.7 notes | Absent | `crates/lsp` | `adapt` | None | Task 2.2 bounded queue and blocked-sender shutdown | `implementing` | — | Flint retained the vulnerable unbounded stdout channel. The final upstream behavior remains a lossless 128-message queue; the only later edit was an unrelated `BufReader` dependency cleanup. |
