...
| P2 | [#61275 worktree scanning](https://github.com/zed-industries/zed/pull/61275) | `ac5538b7239196b7413da76a6258bc9ac4a017fe` | v1.13.0-pre notes | Absent | `crates/worktree`, `crates/worktree_benchmarks` | `adapt` | None | `worktree_benchmarks --deferred-directories 10000` | `implementing` | — | Tombstone assignment reduced median scan completion from 140.27 ms to 82.17 ms across five runs, a 41.42% improvement. |
