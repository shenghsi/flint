...
| Priority | Upstream PR | Final commit | Provenance | Fork ancestry | Flint paths | Strategy | Prerequisites | Required tests | Status | Flint PR | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P1 | [#60292](https://github.com/zed-industries/zed/pull/60292) | `4aa8ad9742b1ee948d64429a5814d9b9a861350a` | v1.11 notes | Absent | `crates/agent_threads`, `crates/terminal_view`, default keymaps | `reimplement` | None | Task 4.1 opt-in context, local/resumed launch, and terminal search | `implementing` | [#94](https://github.com/shenghsi/flint/pull/94) | Agent terminals reuse `buffer_search::Deploy`; the shared post-launch registration path covers restored, Direct, and Tunneled threads without restoring `agent_ui`. Hidden kinds do not remove search from an already launched center-pane terminal, and panel width does not participate in its layout. |
