...
| P1 | [#56487](https://github.com/zed-industries/zed/pull/56487) | `0b458e53a5b52fb205f8420db3f12315e9268915` | v1.10 notes | Absent | `crates/extension_host`, `crates/extension` | `adapt` | None | Task 3.6b language-provider dependency selection, deduplication, and missing-provider fallback | `implementing` | — | Language-only extensions sync only when required by a remote-loadable extension. Zed extension compatibility identifiers remain unchanged. |
