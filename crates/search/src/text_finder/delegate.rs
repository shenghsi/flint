...
mod tests {
    ...
    #[gpui::test]
    async fn test_collapses_one_result_group_without_hiding_other_files(cx: &mut TestAppContext) {
        ...
        picker.update(cx, |picker, _| {
            ...
            assert_eq!(
                picker
                    ...
                    .entries
                    .iter()
                    .filter(|entry| matches!(entry, Entry::Match(_)))
                    .count(),
                2
            );
