...
impl EditPredictionDelegate for FlintEditPredictionDelegate {
    fn name() -> &'static str {
        "flint-predict"
    }

    fn display_name() -> &'static str {
        "Flint's Edit Predictions"
    }
