...
use crate::{EditPredictionStore, FlintPredictUpsell};
...
/// Introduces user to Flint's Edit Prediction feature
pub struct FlintPredictModal {
                    ...
                    EditPredictionOnboarding::new(
                        ...
                        Arc::new({
                            ...
                            move |_window, cx| {
                                ...
                                set_edit_prediction_provider(EditPredictionProvider::Flint, cx);
...
impl EventEmitter<DismissEvent> for FlintPredictModal {}

impl Focusable for FlintPredictModal {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl ModalView for FlintPredictModal {
...
impl Render for FlintPredictModal {
