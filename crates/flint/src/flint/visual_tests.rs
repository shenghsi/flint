...
//! Visual testing infrastructure for Flint.
//!
//! This module provides utilities for visual regression testing of Flint's UI.
//! It allows capturing screenshots of the real Flint application window and comparing
...
//! cargo test -p flint visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p flint visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary Flint subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Flint workspace.
    ///
