...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Flint Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Flint Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Flint Editor Preview Instance Running",
        ReleaseChannel::Stable => "Flint Editor Stable Instance Running",
    }
}
