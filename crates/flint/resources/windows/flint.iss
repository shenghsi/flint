...
AppPublisher=Flint Industries
AppPublisherURL=https://www.flint.dev/
AppSupportURL=https://www.flint.dev/
AppUpdatesURL=https://www.flint.dev/
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\flint"; ValueType: "string"; ValueData: "URL:flint Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\flint"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\flint\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Flint.exe,1"
Root: HKCU; Subkey: "Software\Classes\flint\shell\open\command"; ValueType: "string"; ValueData: """{app}\Flint.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\flint_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
