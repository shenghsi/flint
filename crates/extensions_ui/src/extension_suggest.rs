            ...
            cx.new(move |cx| {
                MessageNotification::new(
                    localization::tr!(
                        ...
                        file_type = file_name_or_extension.to_string()
                    ),
                    cx,
                )
                .primary_message(localization::text(cx, "extensions-install-recommended"))
                ...
                .secondary_message(localization::text(cx, "extensions-do-not-install"))
