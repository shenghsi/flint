        ...
        let menu = right_click_menu(ix)
            ...
            .menu(move |window, cx| {
                ...
                ContextMenu::build(window, cx, move |mut menu, _window_, cx| {
                    menu = menu.entry(
                        localization::text(cx, "common-close-tab"),
                        None,
                        move |window, cx| {
                    ...
                    menu = menu.entry(
                        localization::text(cx, "common-close-other-tabs"),
                        None,
                        move |window, cx| {
                            Self::handle_right_click_action(
                                cx,
                    ...
                    menu = menu.entry(
                        localization::text(cx, "common-move-tab-new-window"),
                        None,
                        move |window, cx| {
                            Self::handle_right_click_action(
                                cx,
                    ...
                    menu = menu.entry(
                        localization::text(cx, "common-show-all-tabs"),
                        None,
                        move |window, cx| {
                            Self::handle_right_click_action(
                                cx,
