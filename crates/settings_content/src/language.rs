...
impl EditPredictionProvider {
    pub fn is_flint(&self) -> bool {
        match self {
            EditPredictionProvider::Flint => true,
    ...
    pub fn display_name(&self) -> Option<&'static str> {
        match self {
            EditPredictionProvider::Flint => Some("Flint AI"),
...
pub struct EditPredictionSettingsContent {
    ...
    /// Controls whether Flint may collect training data when using Flint's Edit Predictions.
...
/// Controls whether Flint collects training data when using Flint's Edit Predictions.
#[derive(
    Copy,
    Clone,
    Debug,
...
pub enum EditPredictionDataCollectionChoice {
    ...
    #[default]
    Default,
    /// Allow Flint to collect training data from open-source projects.
    Yes,
